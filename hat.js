...
class Hat {
    ...
    static THOUGHTS = [
        {
            thought: "¿Te sientes valiente, verdad?",
            team: TEAMS.GRYFFINDOR
        },
        {
            thought : "Pareces ser un tipo osado",
            team : TEAMS.GRYFFINDOR
        },
        {
            thought : "¡Eres alguien completamente lleno de ambicion!",
            team : TEAMS.SLYTHERIN
        },
        {
            thought : "Tu orgullo podría ser tu perdicion",
            team : TEAMS.SLYTHERIN
        },
        {
            thought : "Hay mucha paciencia en ti",
            team : TEAMS.HUFFLEPUFF
        },
        {
            thought : "No le temes al trabajo pesado, ¿Verdad?",
            team : TEAMS.HUFFLEPUFF
        },
        {
            thought : "Eres del tipo cuidadoso",
            team : TEAMS.RAVENCLAW
        },
        {
            thought : "Noto esa sabiduria e inteligencia en ti",
            team : TEAMS.RAVENCLAW
        }
    ]
    ...
    displayBadgePage(color,name){
        ...
        badgeImage.innerHTML=`<img src="hufflepuff_badge.gif" width="200px">
        </img>`;
        ...
        badgeAlert.innerHTML =`<p> Has sid@ seleccionad@ en <strong>¡${name.charAt(0).toUpperCase() + name.slice(1)}! <br></p>`
        // badge
